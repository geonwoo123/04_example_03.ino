...
// Servo adjustment
#define _DUTY_MAX 3000  // Servo angle: D degree
#define _DUTY_NEU 1470  // Servo angle: 0 degree
...
void setup() {
  ...
  dist_target = 5; // 15.5 cm, the center of the rail
}
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 70.1 + -0.501 * a_value + 1.31E-03 * a_value * a_value + -1.17E-06 * a_value * a_value *a_value;
}
